...
BLOG_AUTHOR = "Luciana Marques"  # (translatable)
BLOG_TITLE = "Luciana Marques Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://lucianamarques.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://lucianamarques.github.io/"
BLOG_EMAIL = "lucianadacostamarques@gmail.com"
BLOG_DESCRIPTION = "Hey there! My name is Lu and this is my blog. Here I will talk mainly about software engineering and open source projects, and ocasionally about other things."  # (translatable)
